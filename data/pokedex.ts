export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	arbokmega: {
		...
		forme: "Mega",
		types: ["Poison", "Dark"],
		baseStats: {hp: 60, atk: 130, def: 100, spa: 90, spd: 65, spe: 95},
		abilities: {0: "Petrify"},
		heightm: 3.5,
		weightkg: 65,
		color: "Purple",
  ...
  inflagetah: {
	...
	inflagetahmega: {
		...
		types: ["Fire"],
    genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 140, def: 80, spa: 80, spd: 90, spe: 175},
		abilities: {0: "Acceleration"},
    heightm: 1.7,
    weightkg: 45.5,
    color: "Red",
  ...
  jackdeary: {
    ...
    abilities: {0: "Magic Guard", 1: "Inner Focus", H: "Inner Focus"},
    heightm: 0.6,
    weightkg: 11.2,
    color: "Pink",
    evos: ["Winotinger"],
  ...
  jungore: {
    ...
    abilities: {0: "Battlearmor", 1: "Clear Body"},
    heightm: 0.8,
    weightkg: 56.9,
    color: "Brown",
    evos: ["Majungold"],
